                    ...
                    <div className="bg-brand-secondary rounded-2xl p-8 border border-brand-tertiary">
                        <div className="prose prose-invert max-w-none">
                            ...
                            <ul className="text-gray-300 mb-6 space-y-3">
                                ...
                                <li><strong className="text-white">Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to MongoSnap.</li>
                                ...
                                <li><strong className="text-white">Country</strong> refers to: Telangana, India</li>
                                ...
                                <li><strong className="text-white">Third-party Social Media Service</strong> refers to any website or any social network website through which a User can log in or create an account to use the Service.</li>
                                ...
                                <li><strong className="text-white">Website</strong> refers to MongoSnap, accessible from <a href="https://mongosnap.live" rel="external nofollow noopener" target="_blank" className="text-brand-quaternary hover:text-white transition-colors">mongosnap.live</a></li>
                            ...
                            <h4 className="text-lg font-semibold text-white mt-4 mb-2">Information from Third-Party Social Media Services</h4>
                            <p className="text-gray-300 mb-4">
                            ...
                            <h4 className="text-lg font-semibold text-white mt-4 mb-2">Tracking Technologies and Cookies</h4>
                            <p className="text-gray-300 mb-4">
                            ...
                            <p className="text-gray-300 mb-4">We use both Session and Persistent Cookies for the purposes set out below:</p>
                            ...
                            <ul className="text-gray-300 mb-6 space-y-2">
                                ...
                                <li><strong className="text-white">With other users:</strong> when You share personal information or otherwise interact in the public areas with other users, such information may be viewed by all users and may be publicly distributed outside. If You interact with other users or register through a Third-Party Social Media Service, Your contacts on the Third-Party Social Media Service may see Your name, profile, pictures and description of Your activity. Similarly, other users will be able to view descriptions of Your activity, communicate with You and view Your profile.</li>
                            ...
                            <h3 className="text-xl font-semibold text-white mt-6 mb-3">Retention of Your Personal Data</h3>
                            <p className="text-gray-300 mb-4">
                            ...
                            <h3 className="text-xl font-semibold text-white mt-6 mb-3">Transfer of Your Personal Data</h3>
                            <p className="text-gray-300 mb-4">
                            ...
                            <h3 className="text-xl font-semibold text-white mt-6 mb-3">Delete Your Personal Data</h3>
                            <p className="text-gray-300 mb-4">
                            ...
                            <h3 className="text-xl font-semibold text-white mt-6 mb-3">Disclosure of Your Personal Data</h3>
                            
                            <h4 className="text-lg font-semibold text-white mt-4 mb-2">Business Transactions</h4>
                            <p className="text-gray-300 mb-4">
                                If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.
                            </p>

                            <h4 className="text-lg font-semibold text-white mt-4 mb-2">Law enforcement</h4>
                            <p className="text-gray-300 mb-4">
                                Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).
                            </p>

                            <h4 className="text-lg font-semibold text-white mt-4 mb-2">Other legal requirements</h4>
                            ...
                            <h3 className="text-xl font-semibold text-white mt-6 mb-3">Security of Your Personal Data</h3>
                            <p className="text-gray-300 mb-6">
                            ...
                            <ul className="text-gray-300 space-y-2">
                                <li>By email: <a href="mailto:support@mongosnap.live" className="text-brand-quaternary hover:text-white transition-colors">support@mongosnap.live</a></li>
                                <li>By visiting this page on our website: <a href="/contact" className="text-brand-quaternary hover:text-white transition-colors">www.mongosnap.live/contact</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
