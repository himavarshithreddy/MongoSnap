...
function Login() {
    ...
    return (
        <div id='main' className='w-full min-h-screen bg-[#101813] flex justify-center items-center'>
            ...
            <div id='container' className='md:w-[80%] md:min-h-[85%] w-[90%] min-h-full bg-[#121c16] rounded-lg flex md:justify-between md:flex-row flex-col md:gap-50 gap-10 py-10 md:py-5'>
