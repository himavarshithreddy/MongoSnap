...
importers:
  ...
  apps/frontend:
    dependencies:
      ...
      vite-plugin-qrcode:
        specifier: ^0.2.4
        version: 0.2.4(vite@6.3.5(jiti@2.4.2)(lightningcss@1.30.1))
    devDependencies:
      '@eslint/js':
        specifier: ^9.25.0
        version: 9.29.0
...
packages:
  ...
  vite-plugin-qrcode@0.2.4:
    resolution: {integrity: sha512-XFNNSCTXdxCZFJrVVJlwFD6yk3jhf14xDFImI9y34FpIcRPjGcdmXXZ6V8YO6LUisB+n5AMbYITe2J7rOxwhmA==}
...
snapshots:
  ...
  vite-plugin-qrcode@0.2.4(vite@6.3.5):
    dependencies:
      qrcode-terminal: 0.12.0
      vite: 6.3.5
